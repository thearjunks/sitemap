...
export function RemovedUrlsDashboard() {
  ...
  return <div className="app-shell">
    ...
    <main className="main">
      <header className="topbar"><div className="top-title"><span className="top-product">STC URL intelligence</span><span>Removal archive</span></div><div className="top-actions"><Link className="btn" href="/#url-registry">View All URLs</Link><button className="icon-btn" aria-label="Refresh removed URLs" title="Refresh removed URLs" onClick={load}>⟳</button></div></header>
