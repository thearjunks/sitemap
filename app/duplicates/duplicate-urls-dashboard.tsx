  ...
  return <div className="app-shell">
    ...
    <main className="main">
      ...
      <div className="content">
        <div className="heading-row"><div><span className="page-label">Data quality</span><h1>Duplicate URLs</h1><p className="subhead">Review URL variants that point to the same canonical path, keep one preferred record, or remove an entire duplicate set.</p></div><div className="button-row"><a className="btn" href="/#url-registry">View all URLs</a><button className="btn primary" disabled={!extraIds.length} onClick={() => setSelected(extraIds)}>Select extras</button></div></div>
